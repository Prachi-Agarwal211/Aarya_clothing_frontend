  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-[#0B0608]/40 backdrop-blur-md border border-[#B76E79]/15 rounded-2xl p-4 flex items-center gap-4">
          <div className="p-3 rounded-xl bg-[#7A2F57]/20">
            <Package className="w-6 h-6 text-[#F2C29A]" />
          </div>
          <div>
            <p className="text-[#EAE0D5]/60 text-sm">Total SKUs</p>
            <p className="text-2xl font-bold text-[#F2C29A]">{stats.total}</p>
          </div>
        </div>
        <div
          className="bg-[#0B0608]/40 backdrop-blur-md border border-orange-500/20 rounded-2xl p-4 flex items-center gap-4 cursor-pointer hover:border-orange-500/40 transition-colors"
        ...
        <div
          className="bg-[#0B0608]/40 backdrop-blur-md border border-red-500/20 rounded-2xl p-4 flex items-center gap-4 cursor-pointer hover:border-red-500/40 transition-colors"
      ...
      {/* Tabs */}
      <div className="flex gap-1 bg-[#0B0608]/40 border border-[#B76E79]/15 rounded-xl p-1 w-fit">
        {TABS.map((tab) => (
          <button
            key={tab}
            ...
            {loading ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  ...
                  <tbody className="divide-y divide-[#B76E79]/5">
                    {filtered.map((item) => (
                      <tr key={item.id} className="hover:bg-[#B76E79]/5 transition-colors">
                        ...
                        <td className="px-5 py-4 text-sm text-[#EAE0D5]/70">
                        ...
                        <td className="px-5 py-4 text-center text-sm text-[#EAE0D5]/50">
                        ...
                        <td className="px-5 py-4 text-center">
                          <StockBadge quantity={item.quantity} threshold={item.low_stock_threshold || 5} />
                        </td>
                        <td className="px-5 py-4 text-right">
                          <button
                            onClick={() => setAdjustItem(item)}
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#7A2F57]/20 border border-[#B76E79]/20 text-[#EAE0D5]/70 hover:text-[#F2C29A] hover:bg-[#7A2F57]/40 transition-colors text-xs ml-auto"
                          >
