...
test.describe('Product Browsing', () => {
  ...
  test.describe('Homepage & Navigation', () => {
    ...
    test('should navigate to new arrivals section on homepage', async ({ page }) => {
      await homePage.goto();
      await homePage.goToNewArrivals();

      // Should scroll to new arrivals section on homepage
      await expect(page).toHaveURL(/\/#new-arrivals$/, { timeout: 10000 });
      
      // Verify new arrivals section is visible
