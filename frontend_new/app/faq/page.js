...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-[#F5F0E8] relative overflow-hidden">
      <EnhancedHeader />
      {/* Background Pattern */}
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-[#111111] via-[#111111] to-[#1a0f12]" />
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#1E3A5F]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#A8B4C8]/10 rounded-full blur-3xl" />
      </div>

      {/* Hero Section */}
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 z-10">
        <div className="container mx-auto px-4 md:px-8 text-center max-w-4xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-[#D4AF37]" style={{ fontFamily: 'Cinzel, serif' }}>
            Frequently Asked Questions
          </h1>
          <p className="text-lg text-[#F5F0E8]/70 font-light" style={{ fontFamily: 'Playfair Display, serif' }}>
        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-1/3">
              <div className="bg-[#111111]/40 backdrop-blur-md border border-[#A8B4C8]/20 rounded-2xl p-6 sticky top-32">
                <h3 className="text-xl font-medium mb-6 text-[#D4AF37]" style={{ fontFamily: 'Cinzel, serif' }}>
                  Categories
                </h3>
                    ...
                    <button
                      ...
                      className={`text-left px-4 py-3 rounded-xl transition-all duration-300 ${
                        openCategory === category.id
                          ? 'bg-gradient-to-r from-[#1E3A5F] to-[#A8B4C8] text-white font-medium shadow-lg shadow-[#1E3A5F]/20'
                ...
                {/* Contact Help */}
                <div className="mt-10 pt-8 border-t border-[#A8B4C8]/20">
                  <h4 className="text-lg font-medium mb-4 text-[#D4AF37]" style={{ fontFamily: 'Cinzel, serif' }}>
                    Still need help?
                  </h4>
                  <div className="space-y-4">
                    <a href="mailto:support@aaryaclothing.com" className="flex items-center gap-3 text-[#F5F0E8]/70 hover:text-[#D4AF37] transition-colors">
                      <div className="w-10 h-10 rounded-full bg-[#A8B4C8]/10 flex items-center justify-center border border-[#A8B4C8]/20">
                        <Mail className="w-4 h-4" />
                      </div>
                      <span className="text-sm">support@aaryaclothing.com</span>
                    </a>
                    <a href="tel:+919876543210" className="flex items-center gap-3 text-[#F5F0E8]/70 hover:text-[#D4AF37] transition-colors">
                      <div className="w-10 h-10 rounded-full bg-[#A8B4C8]/10 flex items-center justify-center border border-[#A8B4C8]/20">
                        <Phone className="w-4 h-4" />
                      </div>
                      <span className="text-sm">+91 98765 43210</span>
                    </a>
                    <Link href="/contact" className="flex items-center gap-3 text-[#F5F0E8]/70 hover:text-[#D4AF37] transition-colors">
                      <div className="w-10 h-10 rounded-full bg-[#A8B4C8]/10 flex items-center justify-center border border-[#A8B4C8]/20">
            ...
            <div className="lg:w-2/3">
              <div className="space-y-4">
                {faqs[openCategory]?.map(faq => (
                  <div 
                    key={faq.id}
                    className="bg-[#111111]/40 backdrop-blur-md border border-[#A8B4C8]/20 rounded-2xl overflow-hidden transition-all duration-300 hover:border-[#A8B4C8]/40"
                  >
                    <button
                    ...
                    >
                      ...
                      <div className={`flex-shrink-0 w-8 h-8 rounded-full border border-[#A8B4C8]/30 flex items-center justify-center transition-transform duration-300 ${
                        openQuestion === faq.id ? 'bg-[#A8B4C8]/20 rotate-180' : ''
                      }`}>
                    ...
                    >
                      <div className="px-6 pb-6 pt-0 text-[#F5F0E8]/70 leading-relaxed font-light">
                        {faq.a}
                      </div>
                    </div>
                  </div>
