...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen text-[#EAE0D5] page-wrapper">
              ...
              <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#EAE0D5]/60 text-sm">
                          <a href="mailto:support@aaryaclothing.in" className="text-[#B76E79] hover:underline">support@aaryaclothing.in</a>
                        </p>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#EAE0D5]/60 text-sm">
                          <a href="tel:+919876543210" className="text-[#B76E79] hover:underline">+91 98765 43210</a>
                        </p>
                        <p className="text-[#EAE0D5]/40 text-xs mt-1">
                ...
                <div className="rounded-3xl p-8 bg-[#0B0608]/40 backdrop-blur-md border border-[#B76E79]/15">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <a href="/payment-policy" className="px-4 py-2 rounded-lg bg-[#B76E79]/10 border border-[#B76E79]/20 text-[#EAE0D5] text-sm hover:bg-[#B76E79]/20 transition-colors">
                      Payment Policy
                    </a>
