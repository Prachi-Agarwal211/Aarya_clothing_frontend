...
class CheckoutPage {
  constructor(page) {
    ...
    this.razorpayOption = page.locator('input[value="razorpay"], .razorpay-option, button:has-text("Razorpay"), button:has-text("Online Payment")');
    this.razorpayLabel = page.locator('label:has-text("Razorpay"), label:has-text("Online Payment"), .razorpay-label');
  ...
  async selectPaymentMethod(method) {
    switch (method.toLowerCase()) {
      ...
      case 'card':
      case 'netbanking':
        await this.razorpayOption.click();
        break;
    }
