              ...
              {stepNum < TOTAL_STEPS && (
                <div
                  className={`w-10 sm:w-16 h-0.5 mx-1.5 sm:mx-2 rounded transition-all duration-300 ${
                    stepNum < step ? 'bg-[#D4AF37]' : 'bg-[#A8B4C8]/30'
                  }`}
                />
              )}
            </div>
        ...
        <>
          ...
          <form className="w-full space-y-3 sm:space-y-3.5 animate-fade-in-up-delay" onSubmit={handleRequestOtp} noValidate>
            <div className="space-y-2">
              <p className="text-[#F5F0E8]/60 text-[10px] uppercase tracking-widest">Verification</p>
              <div className="grid grid-cols-3 gap-2">
                ...
                >
                  <Mail className={`w-5 h-5 transition-colors ${verificationMethod === 'otp_email' ? 'text-[#D4AF37]' : 'text-[#A8B4C8]'}`} />
                  <p className="text-[10px] sm:text-[11px] text-[#F5F0E8]/90 font-bold tracking-widest">EMAIL</p>
                </button>
                ...
                >
                  <MessageCircle className={`w-5 h-5 transition-colors ${verificationMethod === 'otp_whatsapp' ? 'text-[#D4AF37]' : 'text-[#A8B4C8]'}`} />
                  <p className="text-[10px] sm:text-[11px] text-[#F5F0E8]/90 font-bold tracking-widest">WA</p>
                </button>
                ...
                >
                  <Smartphone className={`w-5 h-5 transition-colors ${verificationMethod === 'otp_sms' ? 'text-[#D4AF37]' : 'text-[#A8B4C8]'}`} />
                  <p className="text-[10px] sm:text-[11px] text-[#F5F0E8]/90 font-bold tracking-widest">SMS</p>
                </button>
              </div>
            </div>
            ...
            <div className="luxury-input-wrapper h-11 sm:h-12 rounded-xl relative group flex items-center px-4">
              {verificationMethod === 'otp_email' ? (
                ...
                <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-[#A8B4C8] group-focus-within:text-[#D4AF37] transition-colors duration-300 shrink-0" aria-hidden="true" />
              )}
              <Input
            ...
            <p className="text-center text-[11px] text-[#F5F0E8]/60">
              We&apos;ll send a 6-digit code to your {verificationMethod === 'otp_email' ? 'email' : 'phone'}.
            </p>

            {verificationMethod !== 'otp_email' && (
              <p className="text-[#F5F0E8]/30 text-[10px] uppercase tracking-wider text-center">
      ...
      {step === 2 && (
        <div className="w-full max-w-md mx-auto animate-fade-in-up-delay">
          <div className="text-center mb-4 space-y-1">
            <div className="w-12 h-12 rounded-full bg-[#1E3A5F]/30 border border-[#A8B4C8]/30 flex items-center justify-center mx-auto mb-2">
              {verificationMethod === 'otp_email' ? (
            ...
            <p className="text-white/70 text-xs sm:text-sm break-all px-1">
              To: <strong className="text-[#D4AF37]">{identifier}</strong>
            </p>
          ...
          <button
            ...
            className="w-full mt-3 py-2 text-center text-[#F5F0E8]/40 hover:text-[#F5F0E8]/70 transition-colors text-xs uppercase tracking-widest"
          >
            ← Back
          </button>
        </div>
