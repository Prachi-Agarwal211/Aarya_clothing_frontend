...
const Skeleton = ({ 
  ...
  const baseStyles = 'relative overflow-hidden bg-[#0f1520]';
...
export const SkeletonTable = ({ rows = 5, columns = 4, className }) => (
  <div className={cn('space-y-3', className)}>
    {/* Header */}
    <div className="flex gap-4 p-4 bg-[#111111]/40 rounded-xl">
    ...
    {Array.from({ length: rows }).map((_, rowIndex) => (
      <div key={rowIndex} className="flex gap-4 p-4 bg-[#111111]/40 rounded-xl">
  ...
  <div className={cn('space-y-6', className)}>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="p-6 bg-[#111111]/40 rounded-2xl space-y-3">
  ...
  <div className={cn('grid lg:grid-cols-3 gap-8', className)}>
    <div className="lg:col-span-2 space-y-4">
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="p-4 bg-[#111111]/40 rounded-2xl flex gap-4">
    ...
    <div className="p-6 bg-[#111111]/40 rounded-2xl space-y-4">
