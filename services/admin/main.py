...
from models.analytics import InventoryMovement
...
# Chat REST + WebSocket endpoints have moved to routes/chat.py.
# Site config endpoints have moved to routes/site_config.py.
# Admin order endpoints have moved to routes/orders.py.
# ==================== AI Endpoints ====================
...
# Asset upload endpoints have moved to routes/uploads.py.
# ==================== Quick Actions ====================


# Staff quick-actions launcher has moved to routes/staff_ops.py.
# Detailed analytics endpoints have moved to routes/analytics.py.
# ==================== Staff Dashboard / Orders ====================


# Staff fulfilment dashboard + pending orders have moved to routes/staff_ops.py.
# Excel import/export endpoints have moved to routes/excel.py.
...
# Admin inventory endpoints have moved to routes/inventory.py.
