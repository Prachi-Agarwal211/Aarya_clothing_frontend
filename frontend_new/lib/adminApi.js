...
export const staffApi = {
  ...
  getPendingOrders: () => 
    adminClient.get('/api/v1/staff/orders/pending'),

  getProcessingOrders: () => 
    adminClient.get('/api/v1/staff/orders/processing'),

  processOrder: (orderId, notes = '') => 
    adminClient.put(`/api/v1/staff/orders/${orderId}/process`, { notes }),
  ...
  bulkProcessOrders: (orderIds, notes = '') => 
    adminClient.post('/api/v1/staff/orders/bulk-process', { order_ids: orderIds, notes }),
