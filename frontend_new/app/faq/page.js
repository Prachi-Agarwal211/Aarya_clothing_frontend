  ...
  const faqs = {
    ...
    shipping: [
      ...
      },
      {
        ...
        a: 'We offer free standard shipping on all prepaid orders above ₹1,999. For orders below this amount, a nominal fee of ₹99 is applied. Cash on Delivery (COD) orders have an additional ₹50 handling fee.'
      }
    ],
    returns: [
      {
    ...
    payment: [
      {
        ...
        a: 'We accept all major credit/debit cards, UPI, net banking, and popular mobile wallets. We also offer Cash on Delivery (COD) for most pin codes.'
      },
      {
        id: 'py2',
