...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen text-[#F5F0E8] page-wrapper" role="main" aria-label="About Aarya Clothing">
      {/* Structured Data */}
      <script
      ...
      <div className="relative z-10">
        ...
        <div className="pt-32 pb-20 px-4 max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-[1px] bg-gradient-to-r from-transparent via-[#D4AF37] to-transparent mx-auto" aria-hidden="true" />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="aspect-[3/4] rounded-xl overflow-hidden bg-[#111111]/40 border border-[#A8B4C8]/15 flex items-center justify-center">
                <Image
              ...
              <div className="aspect-[3/4] rounded-xl overflow-hidden bg-[#111111]/40 border border-[#A8B4C8]/15 flex items-center justify-center mt-8">
                <Image
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center border-t border-[#D4AF37]/10 pt-16">
            {[
              ...
              <div key={stat.label}>
                <div className="text-3xl md:text-4xl font-heading text-[#D4AF37] mb-2" style={{ fontFamily: 'Cinzel, serif' }}>{stat.value}</div>
                <div className="text-[#F5F0E8]/60 text-sm uppercase tracking-widest">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
