...
class CustomRole(Base):
    ...
    staff_members = relationship('User', back_populates='custom_role')
...
class IPRestriction(Base):
    ...
    # Relationships
    staff = relationship('User', backref='ip_restrictions')
...
class TimeBasedAccess(Base):
    ...
    # Relationships
    staff = relationship('User', backref='time_access_restrictions')
...
class StaffSession(Base):
    ...
    __table_args__ = (
        Index('idx_staff_sessions_user_active', 'user_id', 'is_active'),
...
class AuditLog(Base):
    ...
    user_agent = Column(Text)
    metadata = Column(JSON)  # Additional context (e.g., affected record IDs)
    created_at = Column(DateTime, default=datetime.utcnow, index=True)
    
    # Relationships
    staff = relationship('User', backref='audit_logs')
