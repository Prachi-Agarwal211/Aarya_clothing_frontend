...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 h-full h-dvh w-full max-w-md bg-[#0B0608] border-l border-[#B76E79]/20 z-[500] cart-drawer flex flex-col animate-slide-in-right">
        {/* Header */}
