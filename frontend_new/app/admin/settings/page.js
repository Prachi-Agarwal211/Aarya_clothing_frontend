      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-[#0B0608]/40 backdrop-blur-md border border-[#B76E79]/15 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-semibold text-[#F2C29A]" style={{ fontFamily: 'Cinzel, serif' }}>Shipping & Logistics</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-xs font-medium text-[#EAE0D5]/60 mb-1.5 uppercase tracking-wider">Free Shipping Threshold (₹)</label>
              <input type="number" value={config.free_shipping_threshold || ''} onChange={e => handleChange('free_shipping_threshold', e.target.value)} className={inputCls} />
              <p className="text-[10px] text-[#EAE0D5]/30 mt-1.5">Set to 0 for always free shipping</p>
            </div>
          </div>
        </div>
