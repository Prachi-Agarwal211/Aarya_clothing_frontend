...
test.describe('Checkout Flow', () => {
  ...
  test.describe('Guest Checkout', () => {
    test('should complete guest checkout with COD', async ({ page }) => {
      // Add product to cart
      ...
      await checkoutPage.fillContactInfo(`guest.${timestamp}@test.com`, '9876543210');
    ...
    test('should require contact information for guest checkout', async ({ page }) => {
      await addToCart(page);
      ...
      // Should show validation or require address first
      await page.waitForTimeout(1000);
    });
    ...
    test('should validate address fields', async ({ page }) => {
      ...
      // Try to save incomplete address
