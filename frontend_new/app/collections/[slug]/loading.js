      ...
      <div className="relative z-10 page-wrapper">
        ...
        <div className="page-content">
          <div className="container mx-auto px-4 sm:px-6 md:px-8 pt-20 pb-6">
            ...
            <div className="h-4 bg-[#A8B4C8]/10 rounded w-40 mb-4" />
            
            {/* Collection header skeleton */}
            <div className="flex items-end gap-6">
              <div className="w-16 h-16 bg-[#A8B4C8]/10 rounded-xl flex-shrink-0 hidden sm:block" />
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 pb-16">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-6 pb-4 border-b border-[#A8B4C8]/10">
              <div className="h-10 bg-[#A8B4C8]/10 rounded-xl flex-1 min-w-[180px]" />
              <div className="h-10 bg-[#A8B4C8]/10 rounded-xl w-36" />
              <div className="h-10 bg-[#A8B4C8]/10 rounded-xl w-24" />
              <div className="h-10 bg-[#A8B4C8]/10 rounded-xl w-36" />
            </div>
