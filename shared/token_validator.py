    ...
    def get_token_info(self, token: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "is_blacklisted": self._is_token_blacklisted(token) if self.redis_client else None
            }
...
def get_token_validator() -> TokenValidator:
    ...
    if _token_validator is None:
        raise RuntimeError("Token validator not initialized. Call init_token_validator() first.")
