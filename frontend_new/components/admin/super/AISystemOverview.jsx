...
export default function AISystemOverview({ stats }) {
  return (
    <div className="bg-gradient-to-r from-[#9333EA]/10 via-[#E07B8B]/10 to-[#9333EA]/10 border border-[#E07B8B]/30 rounded-2xl overflow-hidden backdrop-blur-sm">
      {/* Header */}
      <div className="px-6 py-4 border-b border-[#E07B8B]/20 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#9333EA]/20 flex items-center justify-center">
            <Sparkles className="w-5 h-5 text-[#FFD700]" />
          </div>
          <div>
            <h2 className="text-lg font-bold text-[#FFD700]">AI System Overview</h2>
            <p className="text-xs text-[#F5F5F5]/60">Real-time AI platform metrics</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 p-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-xs text-[#F5F5F5]/60">
          ...
          <p className="text-[10px] text-[#F5F5F5]/40">
        ...
        <div className="space-y-2">
          ...
          <div className="w-full h-1.5 bg-[#0A0A0A] rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-[#9333EA] to-[#E07B8B] transition-all duration-500"
