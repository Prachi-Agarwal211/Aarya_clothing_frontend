  ...
  return (
    <main className="min-h-screen text-[#F5F0E8] selection:bg-[#D4AF37] selection:text-[#000000]">
      <div className="relative z-10 page-wrapper">
        {/* Header skeleton */}
        <div className="h-16 md:h-20 bg-[#111111]/60 border-b border-[#A8B4C8]/10" />
        ...
        <div className="page-content">
          <div className="container mx-auto px-4 sm:px-6 md:px-8 header-spacing">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
              <div className="h-11 bg-[#A8B4C8]/10 rounded-xl flex-1" />
              <div className="h-11 bg-[#A8B4C8]/10 rounded-xl w-48" />
              <div className="h-11 bg-[#A8B4C8]/10 rounded-xl w-32 hidden md:block" />
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div className="hidden md:block w-64 flex-shrink-0 space-y-4">
                ...
                <div className="h-28 bg-[#A8B4C8]/10 rounded-2xl" />
              </div>

              {/* Products grid skeleton */}
              <div className="flex-1">
                <div className="h-4 bg-[#A8B4C8]/10 rounded w-48 mb-4" />
