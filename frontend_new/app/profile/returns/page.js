  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <h2 className="text-xl font-semibold text-[#FFD700]">My Returns &amp; Exchanges</h2>
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="flex-1 sm:flex-none px-3 py-2 bg-[#0A0A0A]/60 border border-[#E07B8B]/20 rounded-lg text-[#F5F5F5] focus:outline-none focus:border-[#E07B8B]/40 text-sm"
          >
      ...
      <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-xl">
        <p className="text-sm text-[#F5F5F5]/70">
          ...
          Submit within <strong className="text-[#F5F5F5]">7 days of delivery</strong>.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="p-8 bg-[#0A0A0A]/40 backdrop-blur-md border border-[#E07B8B]/15 rounded-2xl text-center">
          <RotateCcw className="w-16 h-16 text-[#E07B8B]/30 mx-auto mb-4" />
          <p className="text-[#F5F5F5]/50 mb-2">No return requests found</p>
          ...
          <Link
            href="/profile/orders"
            className="inline-block px-6 py-2 bg-gradient-to-r from-[#9333EA] to-[#E07B8B] text-white rounded-xl hover:opacity-90 transition-opacity"
          >
            View Orders
          </Link>
        </div>
        ...
        <div className="space-y-4">
          {filteredReturns.map((ret) => {
            ...
            return (
              <div
                key={ret.id}
                className="p-4 bg-[#0A0A0A]/40 backdrop-blur-md border border-[#E07B8B]/15 rounded-2xl hover:border-[#E07B8B]/30 transition-colors"
              >
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  {/* Return Info */}
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="font-mono text-[#FFD700]">RET-{ret.id.toString().padStart(6, '0')}</span>
                    ...
                    <p className="text-sm text-[#F5F5F5]/70 mb-1">
                      Order: <Link href={`/profile/orders/${ret.order_id}`} className="text-[#E07B8B] hover:underline">#{ret.order_id}</Link>
                    </p>
                  ...
                  <div className="text-right">
                    <p className="text-lg font-semibold text-[#FFD700]">{formatCurrency(ret.refund_amount)}</p>
                  ...
                  <Link
                    ...
                    className="flex items-center gap-1 px-4 py-2 text-[#E07B8B] hover:text-[#FFD700] transition-colors"
                  >
