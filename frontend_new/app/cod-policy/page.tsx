...
import { CreditCard, Shield, CheckCircle, AlertCircle, Lock, Smartphone } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Payment Policy | Aarya Clothing',
  description: 'Learn about our payment policy at Aarya Clothing. Secure online payments only via Razorpay — UPI, cards, net banking and wallets accepted. No COD.',
  keywords: 'payment policy, online payment, Razorpay, UPI, no COD, secure payment, Aarya Clothing',
  robots: 'index, follow',
};
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-4xl">
        ...
        <div className="relative rounded-3xl p-6 sm:p-8 md:p-12 bg-[#0B0608]/40 backdrop-blur-md border border-[#B76E79]/15 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
          ...
          <section className="mb-10">
            <div className="p-6 rounded-2xl bg-[#F2C29A]/10 border border-[#F2C29A]/25">
              <div className="flex items-center gap-3 mb-3">
                <AlertCircle className="w-6 h-6 text-[#F2C29A] flex-shrink-0" />
                <h2 className="text-xl text-[#EAE0D5] font-medium" style={{ fontFamily: 'Cinzel, serif' }}>
                  Cash on Delivery is Not Available
                </h2>
              </div>
              <p className="text-[#EAE0D5]/70 leading-relaxed">
                Aarya Clothing accepts <strong className="text-[#EAE0D5]">online payments only</strong>. We do not offer Cash on Delivery (COD) or any pay-on-delivery option. All orders must be paid in full at checkout through our secure payment gateway.
              </p>
            </div>
          </section>
