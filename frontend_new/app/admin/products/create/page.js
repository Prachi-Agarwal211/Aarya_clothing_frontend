            ...
            <div className="bg-[#0B0608]/40 backdrop-blur-md border border-[#B76E79]/15 rounded-2xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm text-[#EAE0D5]/70 mb-1">
                    MRP
                    <span className="text-[#EAE0D5]/40 text-xs ml-2">Must be ≥ selling price</span>
                  </label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#EAE0D5]/50">₹</span>
                    <input
              ...
              <div className="flex items-center justify-between mb-1">
                <div>
                  ...
                  <p className="text-xs text-[#EAE0D5]/50 mt-0.5">
                    Add different sizes, colors, or styles (e.g. Red-S, Blue-M). Item codes are auto-generated.
                  </p>
                </div>
                <button
                  type="button"
              ...
              {variants.length > 0 ? (
                ...
                <div className="p-8 border border-dashed border-[#B76E79]/20 rounded-xl text-center mt-4">
                  <p className="text-[#EAE0D5]/50 text-sm">
                    No options added yet. Click &quot;Add Option&quot; to create size/color combinations.
                  </p>
                </div>
              )}
            </div>
