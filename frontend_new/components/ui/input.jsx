...
const Input = React.forwardRef(({ className, type, variant = "default", ...props }, ref) => {
  const baseStyles = "flex h-12 w-full px-4 py-3 text-sm text-[#F5F0E8] transition-all duration-400 placeholder:text-[#737373]/70 placeholder:font-light focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 file:border-0 file:bg-transparent file:text-sm file:font-medium";
  
  const variants = {
    default: cn(
      "rounded-xl border border-[#A8B4C8]/30 bg-[#111111]/40 backdrop-blur-md shadow-lg",
      "focus:border-[#D4AF37]/50 focus:bg-[#111111]/60",
      "focus:shadow-[0_0_20px_rgba(183,110,121,0.2),0_0_40px_rgba(242,194,154,0.1)]",
      "hover:border-[#A8B4C8]/50 hover:bg-[#111111]/50"
    ),
    minimal: cn(
