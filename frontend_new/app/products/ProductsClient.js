...
export default function ProductsContent({ initialFilters, initialData }) {
  ...
  }, [filters.collection_id, filters.minPrice, filters.maxPrice, filters.sort, filters.page, filters.search, fetchProducts]);
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 header-spacing header-spacing-page">
            ...
            <div className="flex gap-6">
              ...
              <aside className={`
                ...
                md:w-64 flex-shrink-0 space-y-4 p-4 md:p-0 bg-[#000000] md:bg-transparent overflow-y-auto
              `}>
                {/* Mobile close button */}
                {showFilters && (
