...
export default function AISystemOverview({ stats }) {
  return (
    <div className="bg-gradient-to-r from-[#1E3A5F]/10 via-[#A8B4C8]/10 to-[#1E3A5F]/10 border border-[#A8B4C8]/30 rounded-2xl overflow-hidden backdrop-blur-sm">
      {/* Header */}
      <div className="px-6 py-4 border-b border-[#A8B4C8]/20 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#1E3A5F]/20 flex items-center justify-center">
            <Sparkles className="w-5 h-5 text-[#D4AF37]" />
          </div>
          <div>
            <h2 className="text-lg font-bold text-[#D4AF37]">AI System Overview</h2>
            <p className="text-xs text-[#F5F0E8]/60">Real-time AI platform metrics</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 p-6">
        ...
        <div className="space-y-2">
          ...
          <div className="w-full h-1.5 bg-[#111111] rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-[#1E3A5F] to-[#A8B4C8] transition-all duration-500"
