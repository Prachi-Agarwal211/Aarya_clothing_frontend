...
def setup_exception_handlers(app: FastAPI):
    ...
    @app.exception_handler(AdminServiceException)
    async def admin_service_handler(request: Request, exc: AdminServiceException):
        """Handle custom admin service exceptions."""
        logger.error(f"Admin service error: {exc.message} - Path: {request.url.path}")
