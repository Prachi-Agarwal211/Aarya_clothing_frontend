...
class CSRFMiddleware(BaseHTTPMiddleware):
    ...
    EXEMPT_ROUTES = [
        ...
        "/api/v1/auth/refresh",
        "/api/v1/auth/verify-email",  # Email verification links (public)
        "/api/v1/auth/send-verification-otp",  # OTP resend (public during registration)
        "/api/v1/auth/verify-otp-registration",  # OTP verification (public during registration)
        "/api/v1/auth/forgot-password-otp",  # Password reset OTP request (public)
        "/api/v1/auth/verify-reset-otp",  # Password reset OTP verification (public)
        "/api/v1/auth/reset-password-with-otp",  # Password reset with OTP (public)
        "/api/vitals",  # Web vitals collection (public analytics)
        "/health",
        "/docs",
        "/openapi.json",
        "/redoc"
