...
class EmailService:
    ...
    def send_email_verification_link(self, to_email: str, verification_url: str) -> bool:
        ...
        # R2 CDN URL for logo
        logo_url = "https://cdn.aaryaclothing.in/logo.png"
        ...
        <head>
            ...
            <style type="text/css">
                @import url('https://fonts.googleapis.com/css2?family=Cinzel:wght@400;600&family=Segoe+UI:wght@400;600&display=swap');
                body {{ margin: 0; padding: 0; min-width: 100%; background-color: #0B0608; }}
                .wrapper {{ width: 100%; table-layout: fixed; background-color: #0B0608; padding-bottom: 40px; }}
                .main {{ background-color: #180F14; margin: 0 auto; width: 100%; max-width: 600px; border-spacing: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #EAE0D5; border-radius: 20px; border: 1px solid rgba(183, 110, 121, 0.3); box-shadow: 0 8px 32px rgba(183, 110, 121, 0.15); }}
                .two-columns {{ text-align: center; font-size: 0; }}
                .two-columns .column {{ width: 100%; max-width: 600px; display: inline-block; vertical-align: top; }}
            </style>
        </head>
        <body style="margin: 0; padding: 0; background-color: #0B0608;">
                        ...
                        <table class="main" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                <td align="center" style="padding: 40px 40px 30px 40px;">
                                    <img src="{logo_url}" alt="Aarya Clothings" width="120" height="120" style="display: block; border: 0; max-width: 100%; height: auto;"/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center" style="padding: 0 40px 30px 40px;">
                                    <h1 style="font-family: 'Cinzel', serif; color: #F2C29A; font-size: 32px; margin: 0; letter-spacing: 2px; text-shadow: 0 2px 8px rgba(242, 194, 154, 0.3);">AARYA</h1>
                                    <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #B76E79; font-size: 14px; margin: 8px 0 0 0; letter-spacing: 4px;">CLOTHINGS</p>
                                </td>
                            </tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td align="center" style="padding-bottom: 25px;">
                                                <h2 style="font-family: 'Cinzel', serif; color: #F2C29A; font-size: 24px; margin: 0; font-weight: 600;">Verify Your Email Address</h2>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center" style="padding-bottom: 30px; font-size: 16px; line-height: 1.7; color: #EAE0D5;">
                                                Thank you for creating an account with Aarya Clothings! Please click the button below to verify your email address and activate your account.
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center" style="padding-bottom: 35px;">
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td align="center" bgcolor="#B76E79" style="border-radius: 12px; background: linear-gradient(135deg, #B76E79 0%, #7A2F57 100%); border: 1px solid rgba(242, 194, 154, 0.2); box-shadow: 0 4px 16px rgba(183, 110, 121, 0.4);">
                                                            <a href="{verification_url}" target="_blank" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 16px; font-weight: 600; letter-spacing: 1px; line-height: 1.4; text-decoration: none; padding: 16px 40px; color: #FFFFFF; display: inline-block; border-radius: 12px;">
                                                                Verify Email &rarr;
                                                            </a>
                                                        </td>
                                                    </tr>
                                        ...
                                        <!-- Expiry Warning -->
                                        <tr>
                                            <td align="center" style="padding-bottom: 20px; font-size: 14px; color: #EAE0D5; opacity: 0.8;">
                                        ...
                                        <!-- Security Note -->
                                        <tr>
                                            <td align="center" style="padding-bottom: 30px; font-size: 14px; color: #EAE0D5; opacity: 0.6;">
                                                If you didn't create an account with Aarya Clothings, you can safely ignore this email.
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding-bottom: 25px;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td style="border-top: 1px solid rgba(183, 110, 121, 0.2);"></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <!-- Fallback Link -->
                                        <tr>
                                            <td align="center" style="font-size: 12px; line-height: 1.6; color: #EAE0D5; opacity: 0.6;">
                                                If the button doesn't work, copy and paste this link into your browser:<br/>
                                                <a href="{verification_url}" target="_blank" style="color: #B76E79; word-break: break-all; text-decoration: none;">{verification_url}</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <!-- Footer -->
                            <tr>
                                <td align="center" style="padding: 25px 40px; border-top: 1px solid rgba(183, 110, 121, 0.2);">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                            <td align="center" style="font-size: 11px; color: #EAE0D5; opacity: 0.5; letter-spacing: 0.5px; line-height: 1.6;">
                                                © 2026 Aarya Clothings. All rights reserved.<br/>
                                                Need help? Contact us at <a href="mailto:support@aaryaclothings.com" style="color: #B76E79; text-decoration: none;">support@aaryaclothings.com</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
        ...
        text_content = f"""
        AARYA CLOTHINGS - Email Verification
        =====================================
        
        Thank you for creating an account with Aarya Clothings!
